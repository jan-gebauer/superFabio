...
pipeTwo = Pipe(300, (yFloor - 50) - 50)
pipeThree = Pipe(500, (yFloor - 50) + 25)
wall = InvisibleWall(xAxis/2, (yFloor - 50))
finished = Finished(700, yFloor - 300)
lava = Lava(1000)
coinOne = Coin(162, (yFloor - 50) - 75) #X coordinate is 150 + 12 because 12 looks nice
coinTwo = Coin(312, (yFloor - 50) - 100)
dalekOne = Dalek(200)
dalekTwo = Dalek(400)


pipes = pygame.sprite.Group(pipeOne, pipeTwo, pipeThree)
coins = pygame.sprite.Group(coinOne, coinTwo)
...
while 1:
	...
	#Ends the game once the hero dies
	deathLava = pygame.sprite.collide_mask(hero, lava)
	if deathLava:
		print ('You died')
		print ("Number of coins:", coinage)
		print ('Your time:', time)
